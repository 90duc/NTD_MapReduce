...
public class UserItemTable {
	static class MyMapper  extends  Mapper<LongWritable, Text, Text, Text>{  
						 ...
						 throws java.io.IOException, java.lang.InterruptedException
		 {
			...
			context.write(new Text(lines[1]), new Text(lines[0]+splitChars[0]+lines[2]));
		 }
	...
	public static String[] run(String INPUT_PATH,String OUTPUT_PATH,String[] splitChars,String[] existSplitChars) throws  Exception {
		...
		UserItemTable.splitChars=splitChars;
		UserItemTable.existSplitChars=existSplitChars;
		...
		job.setJarByClass(UserItemTable.class);
