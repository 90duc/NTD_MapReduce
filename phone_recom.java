// ORM class for table 'phone_recom'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sun Feb 04 04:52:33 PST 2018
...
public class phone_recom extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void set_spid(Integer spid) {
    this.spid = spid;
  }
  public phone_recom with_spid(Integer spid) {
    this.spid = spid;
    return this;
  }
  ...
  public phone_recom with_dpid(Integer dpid) {
    this.dpid = dpid;
    return this;
  }
  ...
  public phone_recom with_degree(Double degree) {
    this.degree = degree;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof phone_recom)) {
      return false;
    }
    phone_recom that = (phone_recom) o;
    boolean equal = true;
    equal = equal && (this.spid == null ? that.spid == null : this.spid.equals(that.spid));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.spid = JdbcWritableBridge.readInteger(1, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(spid, 1 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.spid = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.dpid = null;
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(spid==null?"null":"" + spid, delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.spid = null; } else {
      this.spid = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    phone_recom o = (phone_recom) super.clone();
    return o;
  }

  public void clone0(phone_recom o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new TreeMap<String, Object>();
    __sqoop$field_map.put("spid", this.spid);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("spid".equals(__fieldName)) {
      this.spid = (Integer) __fieldVal;
    }
